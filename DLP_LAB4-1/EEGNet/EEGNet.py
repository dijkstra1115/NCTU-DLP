...
for task in ['EEG', 'DeepConvNet']:
    ...
    for act_func in ['ReLU', 'LeakyReLU', 'ELU']:
        ...
        for epoch in range(epochs):
            ...
            plt_array_accuracy_tmp2.append(test_correct*100)
            plt_array_loss_tmp.append(train_loss)
            plt_array_loss_tmp2.append(test_loss)
            if epoch%150 == 0: print('train epoch= ',epoch,' loss= ',train_loss,' correct= ',train_correct)
            if epoch%150 == 0: print('test  epoch= ',epoch,' loss= ',test_loss,' correct= ',test_correct)

        plt_array_accuracy.append(plt_array_accuracy_tmp)
        plt_array_accuracy.append(plt_array_accuracy_tmp2)
        plt_array_loss.append(plt_array_loss_tmp)
        plt_array_loss.append(plt_array_loss_tmp2)
